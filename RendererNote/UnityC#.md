...
### 实测-SRP合批和GPU Resident Drawer的效率对比：

1.实验一

测试环境：在场景中放置2160个人物模型，一个方向光源

使用SRP合批下的性能分析：

![image-20241216143246098](./img/image-20241216143246098.png)

<img src="./img/image-20241216143358009.png" alt="image-20241216143358009" style="zoom: 50%;" />

使用GPU Resident Drawer技术下的性能分析：

![image-20241216143738387](./img/image-20241216143738387.png)

<img src="./img/image-20241216143720904.png" alt="image-20241216143720904" style="zoom:50%;" />

可以看到Draw Call和Set Pass Call数量都大幅度下降了，但是为什么计算效率并没有提升，反而有一点点下降？性能的波形似乎也差不多。

实验二：

测试环境：在场景中放置2160个人物模型，3个方向光源以及14个点光源

使用SRP合批下的性能分析：

![image-20241216144751502](./img/image-20241216144751502.png)

使用GPU Resident Drawer技术下的性能分析：

![image-20241216144951983](./img/image-20241216144951983.png)

和实验一结果差不多。

实验三：

我了解到，GPU Resident Drawer技术在于解决SRP合批顺序的问题，SRP合批只会对连续的、符合要求的物体进行合批处理，合批有时会被其他物体打断，因此理论上来说，当一个复杂场景有很多种SRP合批类型的物体互相穿插时，这个技术才能达到想要的效果。
